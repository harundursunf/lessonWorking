...
const Bilgiler = () => {
    ...
    useEffect(() => {
        const fetchSozler = async () => {
            try {
                const response = await fetch("/public/bilgiler.txt");
    ...
    return (
        <div className="mt-[208px] bg-white p-5 rounded-3xl shadow-md w-full max-w-[1163px] flex flex-col items-center space-y-8 mt-8 mx-auto">
